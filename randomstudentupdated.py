...
def randomStud(period): #Input your period!
    classList = CLASSES[period] #Get the list corresponding to the chosen period
    return classList[int(random.randrange(len(classList)))] #Return a random index, ranging from 0 to the length of the list.


###Code to Test (take input in the terminal and print it)###
period = int(raw_input("What period: "))
print randomStud(period)
